...
from app.factories.usecases.table.update_table_usecase_factory import update_table_usecase_factory
...
def table_controller_factory(
  ...
  update_table_usecase = Depends(update_table_usecase_factory),
) -> TableController:
  return TableController(
    create_table_usecase = create_table_usecase,
    update_table_usecase = update_table_usecase
  )