...
from app.factories.usecases.user import auth_user_usecase_factory, create_user_usecase_factory, update_user_usecase_factory
...
def user_controller_factory(
  ...
  update_user_usecase=Depends(update_user_usecase_factory)
) -> UserController:
